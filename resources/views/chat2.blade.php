...
@section('content')
    <div class="container-fluid p-0">
        <div class="row col-12" style="height: 720px; overflow: scroll; color: white">
            <div class="col-md-2" style="background: #254284">
                <ul class="row p-0" id="user-box" style="list-style: none; font-weight: bold; font-family: IRANSans-bold; font-size: 20px;">
                    @foreach($friends as $user)
                        <div class="form-check col-12 py-2 bg-danger" style="border-bottom: 1px solid gray; cursor: pointer">
                    ...
                    @foreach($user_groups as $group)
                        <div class="form-check col-12 my-2 py-2" style="border-bottom: 1px solid gray">
                            ...
                            <label class="form-check-label" for="{{$group->id}}">{{$group->name}} <span style="font-size: 12px">(group)</span></label>
                        </div>
                    @endforeach
                </ul>
            </div>
            <div class="col-md-10 bg-primary p-0 m-0"></div>
        </div>
